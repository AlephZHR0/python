...
class Quizinterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(text="Score: {}".format("0"), fg="white", bg=THEME_COLOR)
        self.score_label.grid(row=0, column=1)

        self.canvas = Canvas(height=250, width=300, bg="white")
        self.question_text = self.canvas.create_text(150, 125, text= "Question: aaa", font=("Arial", 20, "italic"), fill=THEME_COLOR, width=280)
    ...
    def give_feedback(self, is_right):
        ...
        self.canvas.after(ms=1000, func=self.get_next_question)